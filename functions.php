...
if (!is_admin()) {
	...
	wp_register_script( 'imgpreload', get_stylesheet_directory_uri() . '/library/js/libs/jquery.imgpreload.min.js', array('jquery'), '1.6', false );
...
function bones_custom_image_sizes( $sizes ) {
    return array_merge( $sizes, array(
        'carousel' => __('home carousel - 1280 x 384'),
...
add_shortcode('gallery', 'skins_gallery_shortcode');
...
function skins_gallery_shortcode( $attr ) {
	$post = get_post();
...
// pulls the gallery shortcode out of $content so you can place them independently in your page
...
function bones_fonts() {
	wp_enqueue_style('googleFonts', 'http://fonts.googleapis.com/css?family=Open+Sans:400,300,700|Oswald:400,300,700');
}
...
function page_cats_tags() {  
	...
	// Add category metabox to tribe_events
	register_taxonomy_for_object_type('category', 'tribe_events');  
}
 // Add to the admin_init hook of your theme functions.php file 
add_action( 'init', 'page_cats_tags' );

// when you have the image url, but need the id
